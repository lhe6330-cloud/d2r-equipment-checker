...
# Format: key=列 B, value=[列 D, 列 E] (跳过列 C 因为重复列 B)
# =============================================================================
ATTRIBUTE_MAP: Dict[str, List[str]] = {
    'Faster cast rate': ['fcr', '施法'],
    'Faster Hit Recovery': ['Fhr', '打击恢复'],
    'Faster Run/Walk': ['frw', '跑'],
    'strength': ['str', '力量'],
    'dexterity': ['dex', '敏捷'],
    'life': ['life', '生命'],
    'vitality': ['vitality', '体能'],
    'energy': ['ene', '精力'],
    'all res': ['allres', '所有抗性'],
    'fire resistance': ['fr', '火抗'],
    'cold resistance': ['cr', '冰抗'],
    'lightning resistance': ['lr', '电抗'],
    'poison resistance': ['pr', '毒抗'],
    'magic find': ['mf', '寻宝'],
    'extro gold': ['eg', '打钱'],
    'mana': ['mana', '法力'],
    'defense': ['def', '防御'],
    'Increased attack speed': ['ias', '攻击速度'],
    'life steal': ['ll', '吸血'],
    'mana steal': ['lm', '吸蓝'],
    'Enhanced Damage/': ['ed', '伤害'],
    'Enhanced Defense': ['ed', '防御'],
    'attack rating': ['ar', '准确率'],
    'socket': ['socket', '孔'],
    'Chance Of Crushing Blow': ['cb', '压碎打击'],
    'Replenish Life': ['replife', '生命恢复'],
    'Chance Of Deadly Strike': ['ds', '致命打击'],
    'To Attack Rating(Based On Character Level)': ['fools', '幻影'],
    'Bonus To Attack Rating (Based On Character Level)': ['visio', '角色等级'],
    'Max dmg': ['max', '最大伤害'],
    'Min dmg': ['min', '最小伤害'],
    'Poison Length Reduced by': ['plr', '中毒时间减少'],
    'to Poison and Bone Skills(Necromancer Only)': ['pnb', '毒骨'],
    'Ethereal': ['Eth', '无形'],
    'Eth and Repairs durability persecond': ['erep', '无形自回'],
    'Eth and Replenishes Quantity': ['erep', '无形自回'],
    'teleport': ['tp', '传送'],
    ...
    'Mind blast': ['mb', '心灵爆震'],
    'Lightning Sentry': ['ls', '雷光哨卫'],
    'Wake of Fire': ['wof', '火焰复苏'],
    'Blade Fury': ['bf', '刀刃之怒'],
    'Fire Blast': ['FB', '火焰爆'],
    'Fire ball': ['FB', '火球'],
    ...
    'Cloak of Shadows': ['cos', '魔影斗篷'],
    'Fade': ['Fade', '能量消解'],
    'Claws of Thunder': ['cot', '雷电爪'],
    'Blades of Ice': ['boi', '寒冰刃'],
    'Phoenix Strike': ['ps', '凤凰击'],
    'Dragon Tail': ['dt', '神龙摆尾'],
    'assassin': ['sin', '刺客'],
    ...
    'Conviction': ['Conv', '信念'],
    'Fist of the Heavens': ['Foh', '天堂之拳'],
    'Combat': ['Combat', '战斗技能'],
    'Offensive': ['Offensive', '攻击灵气'],
    'Shiver Armor': ['SA', '碎冰甲'],
    'Chilling Armor': ['ca', '寒冰装甲'],
    'Frozen Orb': ['fo', '冰封球'],
    'Cold Mastery': ['CM', '冰冷支配'],
    'Blizzard': ['blizz', '暴风雪'],
    'Nova': ['Nova', '新星'],
    'Lightning': ['Lightning', '闪电'],
    'Chain Lightning': ['CL', '连锁闪电'],
    'Thunder Storm': ['ts', '雷云风暴'],
    'Energy Shield': ['es', '能量护盾'],
    'Lightning Mastery': ['lm', '闪电支配'],
    'Fire Wall': ['fw', '火墙'],
    'Meteor': ['Meteor', '陨石'],
    'Hydra': ['Hydra', '九头蛇'],
    'Enchant': ['Enchant', '强化'],
    'Fire Mastery': ['fm', '火焰支配'],
    'Frost Nova': ['FN', '霜之新星'],
    'Fissure': ['Fissure', '火山爆'],
    'Volcano': ['Volc', '火山'],
    'Cyclone Armor': ['Cyclone', '飓风装甲'],
    'Tornado': ['nado', '龙卷风'],
