...
class MainWindow:
    ...
    def _init_widgets(self):
        ...
        self.key_word_input: QLineEdit = w.findChild(QLineEdit, "key_word")
    ...
    def _on_start_clicked(self):
        ...
        try:
            keyword = self.key_word_input.text().strip() if self.key_word_input else ""
    ...
    def _on_add_task_clicked(self):
        ...
        task_name = f"{gear_type}_{keyword}_{mode}" if keyword else f"{gear_type}_{mode}"
    ...
    def _execute_next_task(self):
        ...
        self.key_word_input.setText(task.keyword)
